...
public class DBInitializerECE {
    ...
    public static void main(String[] args) throws IOException, JSchException, ClassNotFoundException, SQLException {
        ...
        Connection connection = DriverManager.getConnection("jdbc:sqlite:./ece.db");
    ...
    public static void initializeComputers(Connection connection, String address) throws SQLException, JSchException, IOException {
        ...
        JSch jsch = new JSch();
        Session session = jsch.getSession(Credentials.USERNAME, "linux13.engr.ucsb.edu");
        session.setPassword(Credentials.PASSWORD);
        session.setConfig("StrictHostKeyChecking", "no");
        session.connect();
        ...
        while ((line = reader.readLine()) != null) {
            ...
            for (String resultRow : lines) {
                if (resultRow.startsWith("128.111.53") && !resultRow.contains(" ")) {
